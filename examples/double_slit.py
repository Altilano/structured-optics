...
beam.double_slit(0.5e-4, 2e-4)    #apply double slit with slit size 50um and distance 200um between the centers of the slits.
...
axes[1].pcolormesh(beam.x, beam.y, beam.int_profile(0), cmap='inferno')
